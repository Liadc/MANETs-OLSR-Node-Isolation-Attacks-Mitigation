...
//**Added for mitigation process and simulations.
  ...
  std::map<Ipv4Address, std::set<Ipv4Address> > oneHopNodesInsideTCmessageFrom2hop; //key = sender of TC, Value = set of Ipv4Addresses of nodes inside of the TC message.
