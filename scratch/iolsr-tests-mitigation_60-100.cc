...
int main (int argc, char *argv[]){
	...
	// Variables
	uint32_t nNodes = 100;//Nmber of nodes in the simulation, default 50
	...
	bIsolationAttackNeighbor = true;//execute isolation attack by a random neighbor (Selected for Simulations)
	...
	uint32_t printNodeOutputLog = 1; // 999 to disable this function, otherwise supply node ID.
	...
	//LogComponentEnable ("Inet6SocketAddress", LOG_LEVEL_ALL);
	...
	//LogComponentEnable ("ApplicationPacketProbe", LOG_LEVEL_ALL);
	//LogComponentEnable ("PacketSink", LOG_LEVEL_ALL);
	//LogComponentEnable ("PacketProbe", LOG_LEVEL_ALL);
	//LogComponentEnable ("PcapFile", LOG_LEVEL_ALL);
	//LogComponentEnable ("UdpClient", LOG_LEVEL_ALL);
	//LogComponentEnable ("Time", LOG_LEVEL_ALL);
	//LogComponentEnable ("TimeProbe", LOG_LEVEL_ALL);
